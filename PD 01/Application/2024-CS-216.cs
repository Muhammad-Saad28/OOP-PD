...
namespace BootingCSharp
{
    class Program
    {
        ...
        static int CreateAccount()
        {
            ...
            using (StreamWriter usernameWriter = new StreamWriter("Usernames.txt", append: true))
            {
                usernameWriter.WriteLine(storedUsername);
            }

            // Save password to a file
            using (StreamWriter passwordWriter = new StreamWriter("Passwords.txt", append: true))
            {
